...
module ApplicationHelperPatch
  ...
  module InstanceMethods
    ...
    def textilizable_with_ci_linking(*args)
      ...
      return text.gsub(/([^:\"])https:\/\/ci.arvados.org\/job\/(.*?)\/([0-9]+)\/(\W|$)/,'<a href="https://ci.arvados.org/job/\\2/\\3/">\\2: #\\3 <img src="https://ci.arvados.org/buildStatus/icon?job=\\2&#38;build=\\3" alt="" /></a>\\4').gsub(/([^:\"])https:\/\/ci.arvados.org\/view\/(.*?)\/job\/(.*?)\/([0-9]+)\/(\W|$)/,'<a href="https://ci.arvados.org/view/\\2/job/\\3/\\4/">\\3: #\\4 <img src="https://ci.arvados.org/buildStatus/icon?job=\\3&#38;build=\\4" alt="" /></a>\\5').html_safe
    end
